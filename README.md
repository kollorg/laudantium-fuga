[![Build Status](https://travis-ci.com/kollorg/laudantium-fuga.svg?branch=main)](https://travis-ci.com/kollorg/laudantium-fuga)
...
[![Maintainability](https://api.codeclimate.com/v1/badges/31071476c2117e90d6fe/maintainability)](https://codeclimate.com/github/kollorg/laudantium-fuga/maintainability)
[![Test Coverage](https://api.codeclimate.com/v1/badges/31071476c2117e90d6fe/test_coverage)](https://codeclimate.com/github/kollorg/laudantium-fuga/test_coverage)
...
Install it using npm: `npm install @kollorg/laudantium-fuga`

If used in a browser environment, you will need to manually install the local you wish to support.

```javascript
var languages = require("@kollorg/laudantium-fuga");

// Support german & english languages.
languages.registerLocale(require("@kollorg/laudantium-fuga/langs/en.json"));
languages.registerLocale(require("@kollorg/laudantium-fuga/langs/de.json"));
```
